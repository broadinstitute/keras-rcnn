...
class TestRPN():
    def test_call(self):
        ...
        target_scores = keras.backend.variable([1, 1, 0, 0, 1, 0, 0, 1, 0])#keras.backend.variable([1, 1, 0, -1, 1, 0, -1, -1, 0])
        target_scores = keras.backend.expand_dims(target_scores, 0)
        ...
        #
        # layer.call([output_deltas, target_deltas, output_scores, target_scores])
        #
        # regression_loss = layer.regression_loss
        #
        # regression_loss = keras.backend.eval(regression_loss)
