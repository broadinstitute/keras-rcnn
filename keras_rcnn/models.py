...
def _train(classes, training_options=None):
    ...
    def f(inputs):
        ...
        all_anchors, rpn_labels, bounding_box_targets = keras_rcnn.layers.AnchorTarget(*training_options["anchor_target"])([scores, bounding_boxes, metadata])
        ...
        proposals_ = keras_rcnn.layers.ObjectProposal(*training_options["object_proposal"])([metadata, deltas, scores, all_anchors])

        proposals, labels_targets, bounding_box_targets = keras_rcnn.layers.ProposalTarget(*training_options["proposal_target"])([proposals_, labels, bounding_boxes])
