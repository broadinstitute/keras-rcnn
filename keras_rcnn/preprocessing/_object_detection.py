...
class DictionaryIterator(keras.preprocessing.image.Iterator):
    def __init__(
        ...
        super(DictionaryIterator, self).__init__(len(self.dictionary),
...
class DebugDictionaryIterator(keras.preprocessing.image.Iterator):
    def __init__(
        ...
        self.image_shape = (rows, cols, channels)
        self.scale = 1
        self.target_shape = (448, 448, self.image_shape[2])
...
class DebugObjectDetectionGenerator:
    def flow(self, dictionary, classes):
        return DebugDictionaryIterator(dictionary, classes, self)
